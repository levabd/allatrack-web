const ua = {
  ...
  landing: {
    ...
    show_mobile: 'Мобільна / Веб розробка',
    ...
    services: {
      ...
      web: {
        title: 'Мобільная/Веб розработка',
        description: 'Розробляємо Веб та мобільні системи будь-якої складності'
      }
    },
    solutions: {
      ...
      science: {
        ...
        description: 'Протидія небажаній рекламі. Вибір найкращих оголошень на основі поведінки користувачів'
      },
      cars: {
        img: {
